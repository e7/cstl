...
// 支持的对象大小
static int_t const A_OBJ_SIZE_SURPPORT[] = {
    1 << 3, // 8
    1 << 4, // 16
    1 << 5, // 32
    1 << 6, // 64
...
extern int_t find_mempool(char const *pc_name, mempool_t **pp_pool);

extern int_t mempool_build(mempool_t *const THIS, char const *pc_name);
